CREATE TABLE country (
	...
	short_name character varying(4) NOT NULL UNIQUE,
...
CREATE TABLE tax_category (
	...
	name character varying(255) NOT NULL UNIQUE,
	CONSTRAINT tax_category_id_pkey PRIMARY KEY (tax_category_id)
);
...
CREATE TABLE tax_rate (
	...
	CONSTRAINT tax_rate_id_pkey PRIMARY KEY (tax_rate_id),
	CONSTRAINT tax_rate_country_id_fk FOREIGN KEY (country_id)
		REFERENCES country (country_id) MATCH SIMPLE
		ON UPDATE NO ACTION ON DELETE NO ACTION,
	CONSTRAINT tax_rate_tax_category_id_fk FOREIGN KEY (tax_category_id)
		REFERENCES tax_category (tax_category_id) MATCH SIMPLE
		ON UPDATE NO ACTION ON DELETE NO ACTION
...
CREATE TABLE product (
	...
	CONSTRAINT product_product_category_id_fk FOREIGN KEY (product_category_id)
		REFERENCES product_category (product_category_id) MATCH SIMPLE
		ON UPDATE NO ACTION ON DELETE NO ACTION,
	CONSTRAINT product_tax_category_id_fk FOREIGN KEY (tax_category_id)
		REFERENCES tax_category (tax_category_id) MATCH SIMPLE
		ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE product_price (
	...
	CONSTRAINT product_price_id_pkey PRIMARY KEY (product_price_id),
	CONSTRAINT product_price_country_id_fk FOREIGN KEY (country_id)
		REFERENCES country (country_id) MATCH SIMPLE
		ON UPDATE NO ACTION ON DELETE NO ACTION,
	CONSTRAINT product_price_product_id_fk FOREIGN KEY (product_id)
